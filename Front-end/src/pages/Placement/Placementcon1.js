  ...
  return (
    <div className="container-fluid py-4 my-4">
      <div className="row text-center">
        <h3 className="mb-4 pb-4" style={{ fontFamily: "serif", color: "#66023b",fontWeight:'700',position:'relative',bottom:'2rem' }}>
        Learn skills that get you a job today!
        </h3>
      </div>
      <div style={{position:'relative',bottom:'3rem'}} className="row justify-content-center">
