...
import Banner from "../../../images/testingpic.webp";
        ...
        <StyledContainer sx={{ position: 'relative' }}>
          <Grid container spacing={2} alignItems="center">
            <Grid item xs={12} sm={6} order={{ xs: 2, sm: 1 }}>
              <Typography variant="h4"  style={{color:'#66023b'}} gutterBottom className="responsive-typography">
              <b>Get Hands-on knowledge with Real-Time projects from our dedicated Software Testing training in Coimbatore</b>
              </Typography>
