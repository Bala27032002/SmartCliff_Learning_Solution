...
const JavaTrainingMethodlogy = () => {
  return (
   
      <>
         <Typography variant='h4'sx={{fontWeight:'600',textAlign:'center',color:'#66023b',position:'relative',top:'2rem'}}>Java Training Methodology</Typography>
        <StyledContainer sx={{ position: 'relative' }}>
          <Grid container spacing={2} alignItems="center">
            <Grid item xs={12} sm={6} order={{ xs: 2, sm: 1 }}>
              <Typography variant="h5" style={{fontWeight:'500'}}   gutterBottom className="responsive-typography">
...
export default JavaTrainingMethodlogy;
