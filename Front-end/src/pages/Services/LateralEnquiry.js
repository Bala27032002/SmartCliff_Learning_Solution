...
const LateralEnquiry = ({
  ...
  return (
    <div>
      <Button style={{background:'#66023b',color:'white',position:'relative',bottom:'9rem',left:'15.7rem',width: "100px", height: "40px",fontFamily:'serif'}}
