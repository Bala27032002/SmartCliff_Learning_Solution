...
const McaEnquriy = ({
  ...
  return (
    <div>
      <Button style={{background:'#66023b',color:'white',position:'relative',bottom:'8.7rem',left:'10.7rem',width: "100px", height: "40px",fontFamily:'serif'}}
