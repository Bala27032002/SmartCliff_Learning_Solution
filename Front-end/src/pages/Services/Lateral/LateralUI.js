      ...
      <div className="container my-4">
        <div className="row justify-content-between">
          <div className="col-lg-5 pt-4 text-center" style={{  boxShadow: "0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23)" }}>
            ...
            {/* <Link ><button style={{ marginTop: "40px", width: "100px", height: "40px", fontFamily: "serif", background: '#f5d3e6', color: "black",position:'relative',bottom:'2rem' }} onClick={openModal}>Enquiry Now</button></Link>
            <EnquriyModal  open={isModalOpen} handleClose={closeModal} /> */}
          </div>
